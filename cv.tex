...
\begin{rProject}{\large Bioinformatics Internship, MSD Czech Republic}{Dec 2025 -- Present}{}{}
    \item Member of the Bioinformatics team, focusing on developing computational solutions enhancing drug discovery and development processes.
    \item Applied state-of-the-art and machine learning techniques to enhance protein structural predictions.
\end{rProject}
...
\begin{rProject}{Theoretical and Analytical Skills}{}{}{}
    ...
    \item Computational Neuroscience: Visual System Modeling, EEG Signal Analysis
...
% \begin{rProject}{\large Mgr. Ján Antolík, PhD}{Msc. supervisor}{}{}
%     \item Email: antolik@ksvi.mff.cuni.cz\
% \end{rProject}
% \begin{rProject}{\large Mgr. Marián Novotný, PhD}{}{}{}
%     \item Email: marian.novotny@natur.cuni.cz\
% \end{rProject}
% \end{rSection}
